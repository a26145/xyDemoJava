...
import com.example.xydemo.app.MediaTestApp;
...
public class MediaTestOneActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        mSmallChange.setOnClickListener((View.OnClickListener) this);
...
//
        String proxyUrl = MediaTestApp.getProxy(this).getProxyUrl(VideoConstant.videoUrls[0][9]);
//
        map.put("高清", proxyUrl);
