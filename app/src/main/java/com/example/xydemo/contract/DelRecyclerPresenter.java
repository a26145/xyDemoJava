...
import com.example.xydemo.constant.Constant_StringModel;
...
public class DelRecyclerPresenter implements GankContract.Presenter{
...
//    private final GankUrlService mUrlService;
    ...
    public DelRecyclerPresenter(GankContract.View view, String fragmentType) {
...
//        List<LordMoreEntity> videoEntity = VideoConstant.getVideoEntity();
        mListData.clear();
        mView = view;
        mType = fragmentType;
    }
